...
async def route_startup_private_cloud(request_data: OptimizeRequest):
    ...
    return await startUpPrivateCloud(optimizer_strategy_name, service_list, allocated_nodes, private_cost_func)
...
async def route_update_private_cloud(request_data: OptimizeRequest):
    ...
    if (private_cost_func == "privateCost_v2" ):
        ...
        private_cost_func = privateCost_v1
    return await updatePrivateCloud(optimizer_strategy_name, service_list, allocated_nodes, private_cost_func) 
...
async def route_startup_aws_cloud(request_data: OptimizeRequest):
    ...
    if (private_cost_func == "privateCost_v2" ):
        ...
        private_cost_func = privateCost_v1
    return await startUpAwsCloud(optimizer_strategy_name, service_list, allocated_nodes, private_cost_func)
